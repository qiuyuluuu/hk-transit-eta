...
下班组包含换乘推荐。用户选择“已到大围站”或“已到沙田站”后，页面会结合港铁东铁线实时到站、大学站/沙田站的巴士与小巴 ETA，按站点级换乘时间、尽量减少换乘等待时间的规则推荐换乘站；当前默认沙田站预留 4 分钟，大学站预留 3 分钟。港铁实时可用时标题栏显示绿色状态；港铁实时不可用时会按大围到沙田 3 分钟、沙田到大学 7 分钟估算并继续推荐。
